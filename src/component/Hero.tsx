  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
        {/* Left Column */}
        <div
          className={`w-full lg:w-1/3 bg-gray-50 border-r border-gray-200 flex flex-col justify-center px-6 sm:px-8 py-12 transition-all duration-1000 ${
            isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
          }`}
        >
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-gray-900 text-center lg:text-left">Akash Jain</h1>

          <div className="h-8 mb-6 overflow-hidden relative text-center lg:text-left">
            {skills.map((skill, index) => (
              <p
                key={index}
                className={`text-lg sm:text-xl text-gray-700 absolute transition-all duration-500 ${
                  skillIndex === index
                    ? 'opacity-100 translate-y-0'
                    : 'opacity-0 -translate-y-4'
                }`}
          ...
          <div className="w-16 h-1 bg-gray-900 mb-6 mx-auto lg:mx-0"></div>
        ...
        {/* Right Column */}
        <div
          className={`w-full lg:w-2/3 flex flex-col justify-center items-start px-6 sm:px-8 lg:px-16 py-12 transition-all duration-1000 ${
            isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'
          }`}
        >
          <div className="max-w-xl mx-auto lg:mx-0">
            ...
            <div className="mb-8">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">React Development</h3>
              <p className="text-gray-600">
                Building modern, responsive web applications with React and Next.js. Focused on performance optimization and clean component architecture.
              </p>
            </div>
            ...
            <div className="mb-8">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">UI/UX Design</h3>
              <p className="text-gray-600">
                Creating intuitive, user-centered designs that balance aesthetic appeal with functional usability.
              </p>
            </div>
            ...
            <div className="mb-8">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">Frontend Architecture</h3>
              <p className="text-gray-600">
                Developing scalable frontend architectures with modern tooling, state management, and performance best practices.
              </p>
            </div>
